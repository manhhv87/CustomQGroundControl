                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            GridLayout {
                                ...
                                QGCLabel {
                                    id: udpPort3Label
                                    text: qsTr("UDP Port 4")
                                    visible: true
                                }
                                
                                FactTextField {
                                    Layout.preferredWidth: _comboFieldWidth - 20
                                    fact: _videoSettings.udpPort3
                                    visible: udpPort3Label.visible
                                }

                                QGCLabel {
                                    id: udpPort4Label
                                    text: qsTr("UDP Port 5")
                                    visible: true
                                }
                                
                                FactTextField {
                                    Layout.preferredWidth: _comboFieldWidth - 20
                                    fact: _videoSettings.udpPort4
                                    visible: udpPort4Label.visible
                                }

                                QGCLabel {
                                    id: udpPort5Label
                                    text: qsTr("UDP Port 6")
                                    visible: true
                                }
                                
                                FactTextField {
                                    Layout.preferredWidth: _comboFieldWidth - 20
                                    fact: _videoSettings.udpPort5
                                    visible: udpPort5Label.visible
                                }
                            }
                        }
                    }
