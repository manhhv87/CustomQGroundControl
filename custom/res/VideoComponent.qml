...
Item {
    id:     itemScreen
    clip:   true
    width: videoScreen.subScreenWidth
    height: videoScreen.subScreenHeight
...
//            if (isZoom) {
//                isZoom = false
//                parent.width = videoScreen.subScreenWidth
//                parent.height = videoScreen.subScreenHeight
//                parent.x = parent.idx
//                parent.y = parent.idy
//            } else {
//                isZoom = true
//                parent.width = videoScreen.width
//                parent.height = videoScreen.height
//                parent.idx = parent.x
//                parent.idy = parent.y
//                parent.x = videoScreen.x
//                parent.y =
//            }
        }
    }
