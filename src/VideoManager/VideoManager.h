...
public:
    ...
    Q_PROPERTY(bool             decoding3               READ    decoding3                                   NOTIFY decodingChanged3)
    Q_PROPERTY(bool             decoding4               READ    decoding4                                   NOTIFY decodingChanged4)
    Q_PROPERTY(bool             decoding5               READ    decoding5                                   NOTIFY decodingChanged5)
    ...
    bool decoding3(void) {
        qCDebug(VideoManagerLog) << "Has video 3: " << _multiVideoManager->_hasVideo[3];
        return _multiVideoManager->_hasVideo[3];
    }

    bool decoding4(void) {
        qCDebug(VideoManagerLog) << "Has video 4: " << _multiVideoManager->_hasVideo[4];
        return _multiVideoManager->_hasVideo[4];
    }

    bool decoding5(void) {
        qCDebug(VideoManagerLog) << "Has video 5: " << _multiVideoManager->_hasVideo[5];
        return _multiVideoManager->_hasVideo[5];
    }
...
signals:
    ...
    void decodingChanged3           ();
    void decodingChanged4           ();
    void decodingChanged5           ();
