...
DECLARE_SETTINGSFACT_NO_FUNC(VideoSettings, udpPort3)
{
    if (!_udpPort3Fact)
    {
...
DECLARE_SETTINGSFACT_NO_FUNC(VideoSettings, udpPort4)
{
    if (!_udpPort4Fact)
    {
        _udpPort4Fact = _createSettingsFact(udpPort4Name);
        connect(_udpPort4Fact, &Fact::valueChanged, this, &VideoSettings::_configChanged);
    }
    return _udpPort4Fact;
}

DECLARE_SETTINGSFACT_NO_FUNC(VideoSettings, udpPort5)
{
    if (!_udpPort5Fact)
    {
        _udpPort5Fact = _createSettingsFact(udpPort5Name);
        connect(_udpPort5Fact, &Fact::valueChanged, this, &VideoSettings::_configChanged);
    }
    return _udpPort5Fact;
}
